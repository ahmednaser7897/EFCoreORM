    ...
    public class SectionConfiguration : IEntityTypeConfiguration<Section>
    {
        public void Configure(EntityTypeBuilder<Section> builder)
        {
          ...
          .UsingEntity<Enrollment>();
            ...
            // it will be applied to all queries on this entity
            // in Program.cs we called .FromSql() , it will bypass the global query filter
            var twoYearsDate = DateOnly.FromDateTime(DateTime.Now.AddYears(-5));
