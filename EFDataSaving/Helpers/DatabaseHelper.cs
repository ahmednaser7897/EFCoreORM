...
namespace EFDataSaving.Helpers
{
                ...
                context.Add(
                    new Author
                    {
                        ...
                        Books = new List<Book>
                        {
                          ...
                          {
                              Id = 1,
                              Title = "Domain-Driven Design: Tackling Complexity in the Heart of Software",Price = 50

                          },
                          new Book
                          {
                              Id = 2,
                              Title = "Domain-Driven Design Reference: Definitions and Pattern Summaries",Price = 50
                ...
                context.Add(
                   new Author
                   {
                       ...
                       Books = new List<Book>
                       {
                          ...
                          {
                              Id = 3,
                              Title = "C# In Depth",Price = 50
                          },
                          new Book
                          {
                              Id = 4,
                              Title = "Real world functional programming",Price = 50
                          }
                       }
                   });
